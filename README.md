...
-	**Important**: If any blocks fail for any reason, please edit the pipeline and manually rerun the block called Create_Spark_Session and  related **failed**  block manually.
